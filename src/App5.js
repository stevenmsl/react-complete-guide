...
import Person from "./Person5/Person";
...
class App5 extends Component {
  ...
  render() {
    // inline styling
    // use radium to support media queries, browser states (:hover, :focus, :active)
    // and modifiers in inline styling
    const style = {
...
export default Radium(App5); // HOC
